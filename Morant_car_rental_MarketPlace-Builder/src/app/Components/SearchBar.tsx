...
const SearchBar = () => {
  ...
  return (
    <div className="fixed top-5 left-0 w-[300px] mx-10 lg:w-full z-50">
      <div className="relative flex items-center gap-4 mx-auto mt-16 lg:mt-5 px-4 py-2 rounded-full border border-gray-300 max-w-[492px]">
        <svg
